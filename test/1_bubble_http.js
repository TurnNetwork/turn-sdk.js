...
describe("web3.bub by http(you must update cfg variable before run this test)", function () {
    before(async function () {
        web3 = new Web3(cfg.provider);
        let gasPrice = web3.utils.numberToHex(await web3.bub.getGasPrice()*10);
        let gas = web3.utils.numberToHex(parseInt((await web3.bub.getBlock("latest")).gasLimit));
        cfg.gasPrice = gasPrice;
        cfg.gas = gas;
        hrp = await web3.bub.getAddressHrp()
