...
var cfg = {
    provider: "/home/bubble/network/data/bubble.ipc", // 请更新成自己的 ws 节点
...
return;
describe.skip("web3.bub by websocket(you must update cfg variable before run this test)", function () {
    ...
    it("contract send method transfertransfer( address to, uint value)", async function () {
        ...
        let signTx = await web3.bub.accounts.signTransaction(tx, cfg.privateKey);
        await web3.bub.sendSignedTransaction(signTx.rawTransaction);
