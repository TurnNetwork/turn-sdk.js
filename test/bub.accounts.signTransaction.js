...
var tests = [
    {
        ...
        // signature from bub_signTransaction
    ...
    describe("accounts", function () {
        ...
        tests.forEach(function (test, i) {
            if (test.error) {
                ...
                it("signTransaction must compare to bub_signTransaction", function(done) {
                    var ethAccounts = new Accounts("", hrp);
                ...
                it("signTransaction will call for gasPrice", function(done) {
                    ...
                    provider.injectValidation(function (payload) {
                        assert.equal(payload.jsonrpc, '2.0');
                        assert.equal(payload.method, 'bub_gasPrice');
                ...
                it("signTransaction will call for networkId", function(done) {
                    ...
                    provider.injectValidation(function (payload) {
                        assert.equal(payload.jsonrpc, '2.0');
                        assert.equal(payload.method, 'bub_networkId');
                        assert.deepEqual(payload.params, []);
                    });
